  ...
  <div class="logo"><a href="index.php"><img src="logo2.png" height="50px"></a></div>
    ...
    <div class="container" style="width: 100%">
        ...
        <?php
            ...
            // Update the SQL query to include group_id
            $r_sql = "SELECT 
                group_ride.group_id,
                group_ride.r_from,
                group_ride.r_to,
                ...
                FROM group_ride
                INNER JOIN addto_group ON group_ride.group_id = addto_group.group_id
                GROUP BY group_ride.group_id; ";
            $r_query = mysqli_query($con, $r_sql);

        ?>

        <div class="ride_request_status_containter">
            <h2>List of Group Ride</h2>
            ...
            <table>
                ...
                <tr>
                    ...
                    <!-- <td>
                        <?php //echo $r_result['group_identity']; ?>
                    </td> -->
                    <td> 
                    <a href="driver_group_response.php?groupId=<?php echo $r_result['group_id']; ?> ">
                            <input type="submit" name="group_accept" value="Accept">
                        </a>
                    </td>
                </tr>
                <?php
