    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" >
      ...
      <div class="errmsg">
        ...
        if(isset($_POST['passenger_login']))
        {
          ...
          $sql = "SELECT * FROM passenger_info WHERE email='$email' AND password='$password'";
      ...
      <input class="button" type="submit" name="passenger_login" value="Log In">
    </form>
    <p>Don't have an account? <a href="passenger_signup.php">Sign up here</a></p>
  </section>
