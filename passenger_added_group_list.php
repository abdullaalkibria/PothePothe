  ...
  <div class="logo"><a href="index.php"><img src="logo2.png" height="50px"></a></div>
    ...
    <div class="container" style="width: 100%;">
        ...
        <?php
            ...
            $sql_addtogroup_ride = "SELECT 
            group_ride.r_from,
            group_ride.r_to,
            group_ride.r_date,
            group_ride.r_time,
            addto_group.group_id
            FROM
                group_ride, addto_group
            WHERE addto_group.passenger_id = $r_user_id
            GROUP BY
                addto_group.group_id
            ORDER BY
                addto_group.add_to_id DESC;
            ";


            $r_query = mysqli_query($con, $sql_addtogroup_ride);
            ...
            // $total_query = mysqli_query($con, $sql_total);
        ...
        <div class="ride_request_status_containter">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td> <a href="passenger_addto_group_ride.php?id=<?php echo $r_result['group_id']; ?>">Leave Group</a> || <a href="group_members.php?id=<?php echo $r_result['group_id']; ?>" >Group Members</a></td>
                </tr>
                <?php
